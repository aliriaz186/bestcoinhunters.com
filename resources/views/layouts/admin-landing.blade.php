...
{{--                    </li>--}}
{{--                    <li class="nav-item" style="margin-left: 20px">--}}
{{--                        <a class="btn btnsimple3 my-2 my-sm-0" style="width: 120px">Add a Coin</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" style="margin-left: 20px">--}}
{{--                        <a class="btn btnsimple2 my-2 my-sm-0" style="width: 100px">Contest</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" style="margin-left: 20px">--}}
{{--                        <a class="btn btnsimple my-2 my-sm-0" style="width: 180px">Promote | Traffic Stats</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" style="margin-right: 20px;margin-left: 20px">--}}
{{--                        <a class="btn btnsimple my-2 my-sm-0" style="width: 130px">Earn With Us</a>--}}
{{--                    </li>--}}
