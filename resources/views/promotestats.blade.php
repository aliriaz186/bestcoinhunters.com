        ...
        <div class="container resppaddingclass">
            ...
            <form id="add-coin-form" action="{{url('save-coin')}}" method="post"  onsubmit="return saveCoin()">
                ...
                <div class="resppaddingclass2" style="background: #181d23;border-radius: 2rem;color: white;margin: 0 auto;max-width: 1200px">
                    <h3 style="color: white;text-align: left;margin-top: 20px">{!! $promote->heading!!}</h3>
                    ...
                    <div class="row" style="margin: 0 auto;max-width: 800px;margin-top: 25px">
                        <div class="col-md-6">
                            <p style="color: white">Promoted coins section</p>
                            <div style="color: white!important;">
                                {!! $promote->promotedcoin !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <p style="color: white">Rotating banner (600x240px)</p>
                            <div style="color: white!important;">
                                {!! $promote->roratingbanner !!}
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin: 0 auto;max-width: 800px;margin-top: 25px">
                        <div class="col-md-6">
                            <p style="color: white">Wide header banner (1022x115px)</p>
                            <div style="color: white!important;">
                                {!! $promote->wideheaderbanner !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <p style="color: white">Pop-up on all pages (any size)</p>
                            <div style="color: white!important;">
                                {!! $promote->popupallpages !!}
                            </div>
                        </div>
                    </div>

                    <p style="margin-top: 20px;text-align: center"> {!! $promote->footer !!}</p>
...
{{--                    <h3 style="color: white;text-align: center;margin-top: 10px">{!!$contest->place3!!}</h3>--}}
