        ...
        <div class="container resppaddingclass">
            ...
            <form id="add-coin-form" action="{{url('save-coin')}}" method="post"  onsubmit="return saveCoin()">
                ...
                <div style="background: #181d23;;border-radius: 2rem;color: white" class="resppaddingclass2">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Symbol</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="symbol" id="symbol" placeholder="e.g. BTC" class="input-box-custom" required>
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Telegram</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="telegram" id="telegram" placeholder="e.g. https://t.me/bitcoin" class="input-box-custom" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Description</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <textarea type="text" name="description" id="description" placeholder="e.g. Bitcoin is a decentralized digital currency" class="input-box-custom-textarea" required></textarea>
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Twitter</span> </p>
                            <input type="text" name="twitter" id="twitter" placeholder="e.g. https://twitter.com/bitcoin" class="input-box-custom" >
                            <br>
                            <br>
                            <p style="font-weight: bold;color: white"><span>Discord</span> </p>
                            <input type="text" name="discord"  id="discord" placeholder="e.g. https://discord.gg/dsvsfe" class="input-box-custom" >
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Market Cap in USD</span> </p>
                            <input type="text" name="marketCap" id="marketCap" placeholder="e.g. 150000" class="input-box-custom">
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Reddit</span></p>
                            <input type="text" name="reddit" id="reddit" placeholder="e.g. https://reddit.com/r/bitcoin" class="input-box-custom">
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Price in USD</span> </p>
                            <input type="text" name="price" id="price" placeholder="e.g. 0.006" class="input-box-custom">
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Logo</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="logo" id="logo" placeholder="e.g. https://i.ibb.co/logo.png" class="input-box-custom" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Launch Date (YYYY-MM-DD)</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="launchDate" id="launchDate" placeholder="e.g. 2021-12-12" class="input-box-custom" required>
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Additional information, other links and addresses</span></p>
                            <textarea type="text" name="information" id="information" class="input-box-custom-textarea"></textarea>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <h3 style="color: white">Contact Addresses</h3>
                            <h3 style="opacity: 0">For later changes to coin info, please provide the following:</h3>
                            <p style="font-weight: bold;color: white"><span>Chain</span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <select type="text" name="chain" id="chain" class="input-box-custom" required style="margin-top: -10px">
                                <option value=""></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <h4 style="color: white">For later changes to coin info, please provide the following:</h4>
                            <p style="font-weight: bold;color: white"><span>Contact Email </span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="email" id="email" placeholder="e.g. example@gmail.com" class="input-box-custom" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Address </span> <span style="color: red;font-size: 12px;margin-left: 8px">  Required</span></p>
                            <input type="text" name="address"  id="address" placeholder="" class="input-box-custom" required>
                        </div>
                        <div class="col-md-6">
                            <p style="font-weight: bold;color: white"><span>Contact Telegram </span></p>
                            <input type="text" name="contactTelegram" id="contactTelegram" class="input-box-custom">
                        </div>
                    </div>
                    <div style="margin: 0 auto;margin-top: 50px;max-width: 300px">
                        <button type="submit" class="add-coin-btn">ADD COIN</button>
                    </div>
                </div>
            </form>

            <a href="{{url('')}}" style="display: none" id="homepage">abc</a>
