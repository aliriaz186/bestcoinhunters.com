...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">CONTEST PAGE</h3>
        <p style="font-size: 13px;">Below is the contest page contents.</p>

        <div class="px-5">
            <form method="post" action="{{url('savecontestpage')}}" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">1st Place</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="place1" class="form-control" id="place1" required>{{$earn->place1}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">2nd Place</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="place2" class="form-control" id="place2" required >{{$earn->place2}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">3rd Place</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="place3" class="form-control" id="place3" required >{{$earn->place3}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">4rth Place</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="place4" class="form-control" id="place4" required >{{$earn->place4}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                ...
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Footer Image <span style="font-size: 12px">(please left it blank if you don't want to change image)</span></p>
                    <div class="row">
                        <div class="col-md-6">
