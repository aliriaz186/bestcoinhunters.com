...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">COINS</h3>
        <p style="font-size: 13px;">Below is a list of all coins.</p>
            ...
            <table class="table table-bordered">
                ...
                @foreach($coins as $key => $coin)
                    <tr>
                        ...
                        <td>{{$coin->name}}</td>
                        <td>{{$coin->symbol}}</td>
                        <td><img src="{{$coin->logo}}" style="width: 50px;height: 40px"></td>
                        <td>
                            @if($coin->status == 0)
                        ...
                        <td><a class="btn btn-info" href="{{url('coin-details')}}/{{$coin->id}}">DETAILS</a></td>
                        <td>
                            @if($coin->status == 0)
                            <a class="btn btn-success" href="{{url('approve-coin')}}/{{$coin->id}}">APPROVE</a> <a class="btn btn-danger ml-2" href="{{url('decline-coin')}}/{{$coin->id}}">DECLINE</a>
                            @elseif($coin->status == 1)
                                <h5 style="color: green">Approved</h5>
                            @elseif($coin->status == 2)
                                <h5 style="color: red">Declined</h5>
