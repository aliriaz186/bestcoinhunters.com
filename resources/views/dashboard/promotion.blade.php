...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        <p style="font-size: 13px;">Below is a list of all approved coins.</p>
            ...
            <table class="table table-bordered">
                ...
                @foreach($coins as $key => $coin)
                    <tr>
                        ...
                        <td>
                            @if($coin->status == 0)
                                <span style="color: blue">Not Promote</span>
                        ...
                        <td>
                            @if($coin->status == 0)
                                <a class="btn btn-success" href="{{url('promote-coin')}}/{{$coin->id}}">Promote</a>
                            @elseif($coin->status == 1)
                                <a class="btn btn-danger" href="{{url('unpromote-coin')}}/{{$coin->id}}">Remove Promotion</a>
                            @endif
                        </td>
                    </tr>
                @endforeach
