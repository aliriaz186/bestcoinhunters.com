...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">BLOGS</h3>
        <p style="font-size: 13px;">Below is a list of all BLOGS/ARTICLES.</p>
            ...
            <table class="table table-bordered">
                ...
                @foreach($blogs as $key => $blog)
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$blog->title}}</td>
                            <td><img src="{{url('view-blog-pic')}}/{{$blog->id}}" style="width: 60px;height: 40px"></td>
                        <td><a class="btn btn-danger" href="{{url('delete-blog')}}/{{$blog->id}}">DELETE</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
