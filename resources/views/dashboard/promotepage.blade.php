...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">PROMOTE | STATS PAGE</h3>
        <p style="font-size: 13px;">Below is the promote page contents.</p>

        <div class="px-5">
            <form method="post" action="{{url('savepromotepage')}}" enctype="multipart/form-data">
                @csrf
                <div>
                    <p style="font-weight: bold">Heading</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="heading" class="form-control" id="heading" required>{{$earn->heading}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="text1" class="form-control" id="text1" required>{{$earn->text1}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Sub Heading</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="subheading" class="form-control" id="subheading" required >{{$earn->subheading}}</textarea>
                        </div>
                    </div>
                </div>

                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Stats Image <span style="font-size: 12px">(please left it blank if you don't want to change image)</span></p>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Packages Heading</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="heading2" class="form-control" id="heading2" required >{{$earn->heading2}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Promoted coins section</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="promotedcoin" class="form-control" id="promotedcoin" required >{{$earn->promotedcoin}}</textarea>
                        </div>
                    </div>
                </div>

                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Rotating banner</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="roratingbanner" class="form-control" id="roratingbanner" required >{{$earn->roratingbanner}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Wide header banner </p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="wideheaderbanner" class="form-control" id="wideheaderbanner" required >{{$earn->wideheaderbanner}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Pop-up on all pages </p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="popupallpages" class="form-control" id="popupallpages" required >{{$earn->popupallpages}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="footer" class="form-control" id="footer" required >{{$earn->footer}}</textarea>
                        </div>
                    </div>
                </div>

                {{--                <div style="margin-top: 15px">--}}
                {{--                    <p style="font-weight: bold">Image <span style="font-size: 12px">(please don't select image if you don't want to change it)</span></p>--}}
                {{--                    <div class="row">--}}
                {{--                        <div class="col-md-6">--}}
                {{--                            <input type="file" name="file" class="form-control" id="file" >--}}
                {{--                        </div>--}}
