...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">CHANGE PASSWORD</h3>

        <div style="max-width: 500px">
            <form method="post" action="{{url('changepasswordpost')}}"  enctype="multipart/form-data">
                @csrf
                <div>
