...
@section('content')
    ...
    <div class="container" style="max-width: 1500px;margin-top: 30px;margin-bottom: 10px">
        ...
        @endif
        <h3 style="letter-spacing: 3px;margin-top: 20px" class="mt-4 mb-3">EARN PAGE</h3>
        <p style="font-size: 13px;">Below is the earn page contents.</p>

        <div class="px-5">
            <form method="post" action="{{url('saveearnpage')}}" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Text 1</p>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div style="margin-top: 15px">
                    <p style="font-weight: bold">Text 2</p>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea type="text" name="text2" class="form-control" id="text2" required >{{$earn->text2}}</textarea>
                        </div>
                    </div>
                </div>
                <div style="margin-top: 15px">
